...
VLESS_XHTTP_DOMAIN=${VLESS_XHTTP_DOMAIN:-"streamlit2.hei.pp.ua"}
VMESS_XHTTP_PORT=${VMESS_XHTTP_PORT:-"3002"}
VMESS_XHTTP_DOMAIN=${VMESS_XHTTP_DOMAIN:-"streamlit3.hei.pp.ua"}
XHTTP_PATH=${XHTTP_PATH:-""}
WS_PORT=${WS_PORT:-"3003"}
WS_DOMAIN=${WS_DOMAIN:-"streamlit4.hei.pp.ua"}
